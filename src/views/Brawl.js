            ...
            <div className="bg-[#212121] px-[10px] py-[15px] xl:px-[25px] xl:py-[30px] rounded-xl">
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <p className="pr-[500px] font-family">303.44</p>
                </div>
                <div className="flex items-center justify-between">
                  <p className="underline font-family">Earned</p>
                  <p className="pr-[500px] font-family">5,093.32</p>
                </div>
                <div className="flex items-center mb-10 justify-between">
                  <p className="underline font-family">Total</p>
                  <p className="pr-[500px] font-family">5,393.76</p>
                </div>
                <div className="flex items-center justify-between">
                  <p className="font-family">Total points</p>
                  <p className="pr-[500px] font-family">10,783.44</p>
                </div>
              </div>

              <div className="flex items-center justify-between bg-black rounded-lg pt-2 py-2 my-4">
                <h3 className="text-white pl-4">STAKE</h3>
                <div className="flex items-center justify-between border border-gray-400 rounded-xl px-[100px] space-x-4 pt-2">
              ...
              <div className="flex justify-between">
                <p className="text-[#5C5C5C] font-family">
                  *Double points toward team and Dashboard score
                </p>
                <button className="bg-[#C90000] h-[47px] w-[250px] rounded-lg text-[24px] font-family">
                  BOOST
                </button>
              </div>
            </div>
