    ...
    <div className='main text-white bg-[url("./assets/images/home_hero_bg.png")]'>
      <Container className="mt-[20px]">
        ...
        <Row className="mb-[40px]">
          <Col className="d-flex border-2 justify-content-between rounded-xl border-black p-4 bg-[#212121] h-full">
            <Col className="col-1 m-1 text-center">
              <Col className="">
                <h1 className="rounded-lg bg-[#000000] text-light">2,863 K</h1>
              </Col>
            ...
            <Col className="col-1 m-1 text-center">
              <Col className="">
                <h1 className="rounded-lg bg-[#000000] text-light">1,833 K</h1>
              </Col>
              <p className="font-family">
            ...
            <Col className="col-1 m-1 text-center">
              <Col className="">
                <h1 className="rounded-lg bg-[#000000] text-light">745 K</h1>
              </Col>
              <p className="font-family">
            ...
            <Col className="col-1 m-1 text-center">
              <Col className="">
                <h1 className="rounded-lg bg-[#000000] text-light">285 K</h1>
              </Col>
              <p className="font-family">
            ...
            <Col className="col-1 m-1 text-center">
              <Col className="">
                <h1 className="rounded-lg bg-[#000000] text-light">42,234</h1>
              </Col>
